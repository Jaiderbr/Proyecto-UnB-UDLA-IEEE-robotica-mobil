...
DEFAULT_V_MAX = 35.0        # max linear speed in cm/s
DEFAULT_V_MIN = -35.0       # min linear speed in cm/s
DEFAULT_V_LINEAR = 20       # linear speed in cm/s
